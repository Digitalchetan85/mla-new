            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="">GGMP Slider Images</h3>
                            </div>
                            <div class="col-md-6">
                                <div class="text-end">
                                    <a href="{{ route('admin.addgallery1') }}" class="btn btn-primary">Add Images</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered align-middle text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $user->name }}</td>
                                        <td><img src="{{ asset('assets/images/gallery1') }}/{{ $user->image }}"
                                                alt="" class="img-responsive" width="400"></td>
                                        <td>
                                            <div class="text-center">
                                                <a
                                                    href="{{ route('admin.editproducts', ['product_slug' => $user->id]) }}"><i
