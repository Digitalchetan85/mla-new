            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="">GGMP Gallery Images</h3>
                            </div>
                            <div class="col-md-6">
                                <div class="text-end">
                                    <a href="{{ route('admin.ggmpaddgallery') }}" class="btn btn-primary">Add Images</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered align-middle text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $user->name }}</td>
                                        <td><img src="{{ asset('assets/images/ggmp-gallery') }}/{{ $user->image }}"
                                                alt="" class="img-responsive" width="400"></td>
                                        <td>
                                            <div class="text-center">
                                                <a
                                                    href="{{ route('admin.ggmpeditproducts', ['product_slug' => $user->id]) }}"><i
