            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Edit MRM Gallery Image</h3>
                            </div>
                            <div class="col-md-6">
                                <div class="text-end">
                                    <a href="{{route('admin.mrmgallery')}}" class="btn btn-primary">All Images</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form enctype="multipart/form-data" wire:submit.prevent='updateproduct'>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                @else
                                                <img src="{{ asset('assets/images/mrm-gallery') }}/{{ $image }}" alt=""
                                                    width="400" class="img-responsive" />
                                                @endif
                                            </div>
                                        </div>
                                        @if (Session::has('success'))
                                        <div class="alert alert-success my-2" role="alert">{{ Session::get('success') }}
                                        </div>
                                        @endif
                                        @if (Session::has('error'))
                                        <div class="alert alert-danger my-2" role="alert">{{ Session::get('error') }}</div>
                                        @endif
                                        <div class="row mt-3">
                                            <div class="col-md-4">
                                                <button type="submit"
