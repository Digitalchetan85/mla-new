                    ...
                    <div class="bg-white shadow py-3 rounded" style="height:320px;">
                        <a href="#scheme26" class="text-decoration-none">
                            <div class="text-center">
                                ...
                                <h6 class="text-center text-danger">Total No of Beneficiaries : 179</h6>
                                <h6 class="text-center text-danger">Total Benefitted Amount (In Rupees) : 4,42,89,901</h6>
                            </div>
                        </a>
                    </div>
                </div>
                        ...
                        <table class="table-bordered text-center">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="fw-bold">1,74,33,135</td>
